...
│   ├── InvoiceController           GET /api/invoices/{id}; POST /{invoiceId}/payments
...
← 201 {id:1, invoiceId:1, amount:179998, paymentMethod:"CARD", status:"SUCCESS"}
```
...
| POST | `/api/invoices/{invoiceId}/payments` | `{paymentMethod}` | `PaymentResponse` 201 | Авторизованный |
